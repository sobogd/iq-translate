...
// (/api/translate, /api/translate-voice). Only anonymous
// identities are challenged: a signed-in account is a verified identity, while
// an anonymous caller can rotate a cookie; the gate keeps automated traffic off
// the two local model engines.
//
